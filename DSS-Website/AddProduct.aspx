<%@ Page Title="" Language="C#" MasterPageFile="~/ClientView.master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="DSS_Website.AddProduct" %>
     ...
     <div class="heads">
      ...
      <div class="add-user">
         <form runat="server">
             ...
             <br>
             <div class="input-register">
                <asp:Button  class="btnChanges" ID="btnSubmit" runat="server" Text="ADD PRODUCT" OnClick="btnSubmit_Click" />
             </div>
         </form>
     </div>
</asp:Content>
